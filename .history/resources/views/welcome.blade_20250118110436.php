...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                ...
                <div class="relative w-80 h-[80px] rounded-lg" id="carousel-container">
                    ...
                    <div class="carousel-wrapper relative overflow-hidden w-full h-full rounded-lg">
                        ...
                        <div class="carousel-items flex transition-transform duration-500 ease-in-out">
                            <div class="carousel-item flex bg-gradient-to-l from-[#924E90] to-[#38194A] font-inter text-white gap-3 px-3 py-3 shadow w-full">
                            ...
                            <div class="carousel-item flex bg-gradient-to-l from-[#fff1f3] to-[#eec9cede] font-inter text-bg_blue gap-3 px-3 py-3 shadow w-full">
                            ...
                            <div class="carousel-item flex rounded-xl bg-gradient-to-l from-[#924E90] to-[#38194A] font-inter text-white gap-3 px-3 py-3 shadow hidden duration-1000 ease-in-out w-full" data-carousel-item >
                                <img src="https://i.ibb.co/5MpqK3W/ts-ver.webp" class="rounded-xl h-10">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function goToNext() {
                currentIndex = (currentIndex + 1) % items.length;  // Loop back to the first slide after the last
                updateCarousel();
            }

            // Go to the previous slide
            function goToPrev() {
                currentIndex = (currentIndex - 1 + items.length) % items.length;  // Loop back to the last slide from the first
                updateCarousel();
            }
