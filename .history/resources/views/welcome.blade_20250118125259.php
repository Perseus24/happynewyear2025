                    ...
                    <div class="absolute top-0 left-1/2 w-96 -translate-x-1/2  z-30 h-20 ">
                        <div class="w-full h-full relative">
                            ...
                            <button type="button" class="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none">
                                <span   data-carousel-prev class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-black opacity-50 dark:bg-gray-800/30 group-hover:bg-black/50 dark:group-hover:bg-gray-800/60  dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                            ...
                            <button type="button" class="absolute top-0 end-0 z-30 flex items-center justify-end w-full h-full px-4 cursor-pointer group focus:outline-none" data-carousel-next>
                                <span data-carousel-next class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-black opacity-50 dark:bg-gray-800/30 group-hover:bg-black/50 dark:group-hover:bg-gray-800/60  dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                                    <svg class="w-3 h-3 text-white dark:text-gray-800 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
