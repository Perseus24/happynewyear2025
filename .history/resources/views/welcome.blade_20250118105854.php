    ...
    <body class="relative">
        ...
        <div class="flex h-[80px] w-80 absolute top-20">
            <div class="relative w-80 h-[80px] rounded-lg" id="carousel-container">
                <!-- Carousel Items -->
                <div class="carousel-wrapper relative overflow-hidden w-full rounded-lg">
                    <div class="carousel-item flex bg-gradient-to-l from-[#924E90] to-[#38194A] font-inter text-white gap-3 px-3 py-3 shadow hidden w-full">
                    ...
                    <div class="carousel-item flex bg-gradient-to-l from-[#fff1f3] to-[#eec9cede] font-inter text-bg_blue gap-3 px-3 py-3 shadow hidden w-full">
                ...
                <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[450px] z-30 h-[80px] flex justify-between items-center">
                    <button class="carousel-prev bg-black text-white p-2 rounded-full">
                        &#8249;
                    </button>
                    <button class="carousel-next bg-black text-white p-2 rounded-full">
                        &#8250;
                    </button>
                </div>
