    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function showSlide(index) {
                // Hide all items and reset the transform of the wrapper
                ...
                // Apply the sliding animation by shifting the wrapper's transform
                carouselWrapper.style.transform = `translateX(-${index * 50}%)`;
            }
