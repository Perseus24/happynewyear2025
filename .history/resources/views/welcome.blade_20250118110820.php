    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updateCarousel() {
                // Apply the smooth transition to the carousel
            ...
            // Go to the next slide (circularly)
            function goToNext() {
                currentIndex = (currentIndex + 1) % items.length; // Loop back to 0 after the last item
                updateCarousel();
            }

            // Go to the previous slide (circularly)
            function goToPrev() {
                currentIndex = (currentIndex - 1 + items.length) % items.length; // Loop back to the last item if at 0
                updateCarousel();
            }
